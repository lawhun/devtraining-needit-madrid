...
[ -f "$REPO_DIR/cocoa-beach-scout-dashboard.html" ]       && cp "$REPO_DIR/cocoa-beach-scout-dashboard.html"       "$SCOUT_DIR/"
[ -f "$REPO_DIR/mansfield-oh-market-scout.html" ]         && cp "$REPO_DIR/mansfield-oh-market-scout.html"         "$SCOUT_DIR/"
